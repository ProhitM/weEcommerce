          ...
          orderData.map((item,index)=>(
            <div key={index} className="py-4 border-t border-b border-gray-300 text-gray-700 flex flex-col md:flex-row md:items-center md:justify-between gap-4 ">
                 ...
                 <img className='w-16 sm:w-20' src={item.image[0]} alt="" />
                  <div>
                    <p className='sm:text-base font-medium'>{item.name}</p>
                     <div className='flex items-center text-base text-gray-800 mt-1 gap-4'>
              ...
              <div className='md:w-1/2 flex justify-between'>
                ...
                <button onClick={loadOrderData} className='border border-gray-300 py-2 px-3 text-sm font-medium rounded-sm cursor-pointer'>Track Order</button>
              </div>
