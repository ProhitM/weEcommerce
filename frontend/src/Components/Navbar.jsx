  ...
  return (
    ...
    <Link to='/'><img src={assets.logo} alt="logo" className='w-36'/></Link>
      ...
      <div className="search flex items-center gap-6">
        ...
        <div className="group relative">
           ...
           {/* dropdwon menu  */}
           {
            ...
            <div className="menu flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-slate-700">
                <p className=' cursor-pointer hover:text-black'>My Profile</p>
                <p onClick={()=>navigate('/orders')} className=' cursor-pointer hover:text-black'>Orders</p>
                <p onClick={logoutfun} className=' cursor-pointer hover:text-black'>Logout</p>
            </div>
            </div>
           }
      ...
      <div className="flex flex-col text-gray-600">
       ...
       <img className="dropdown h-4 rotate-100" src={assets.dropdown_icon} alt="" />
       <p>Back</p>
       </div>
