  ...
  return (
      <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3' action="">
        ...
        <div className='w-full'>
          <p className='text-gray-700 mt-4 mb-3' >Product Name</p>
        ...
        <div className='w-full'>
          ...
          <textarea onChange={(e)=>setDescription(e.target.value)} value={description} className='w-full max-w-125 px-3 py-2'  type="text" maxLength='200' placeholder='Write Content here' />
        </div>

        <div className='flex flex-col sm:flex-row gap-6 sm:gap-8 '>
          <div>
            <p className='text-gray-800 mb-3'>Product Categroy</p>
            <div>
              <select onChange={(e)=>setCategroy(e.target.value)} className='w-full px-3 py-2'>
          ...
          <div>
            <p className='text-gray-800 mb-3'>Sub Categroy</p>
            <div>
          ...
          <div>
            <p className='text-gray-800 mb-3'>Product Price</p>
             <input onChange={(e)=>setPrice(e.target.value)} value={price} className='w-full sm:w-30 px-3 py-2' type="Number" placeholder='25' />
          </div>

        </div>

        <div>
          <p className='text-gray-800 mb-3'>Product Sizes</p>
        ...
        <button type='submit' className='bg-black text-white mt-2 py-3 image1 w-28'>ADD</button>
      </form>
